...
### Pre-requisities:
  ...
  - After clone or download this repository you have to address into main folder project and execute <code> expo install </code> in order to configure the environment.
